<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ch5-1.aspx.vb" Inherits="ch5_1" %>
...
<body>
    ...
    <div>
        ...
        <br />
        您已選的課程如下：<br />
        <asp:TextBox ID="TextBox1" runat="server" Height="110px" TextMode="MultiLine"></asp:TextBox>
