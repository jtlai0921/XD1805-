<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ch5-11_4.aspx.vb" Inherits="ch15_11_4" %>
...
<body>
    ...
    <div style="width: 260px; height: 155px">
...
mso-ansi-language:EN-US;mso-fareast-language:ZH-TW;mso-bidi-language:AR-SA">e-Learning</span><span style="font-size:12.0pt;font-family:&quot;新細明體&quot;,&quot;serif&quot;;mso-ascii-font-family:&quot;Times New Roman&quot;;
...
mso-bidi-language:AR-SA">學員註冊系統</span>
            ...
            <WizardSteps>
                <asp:WizardStep runat="server" StepType="Start" Title="Start">
                    歡迎來到「e-Learing」上線學習之學員註冊系統！
                </asp:WizardStep>
                <asp:WizardStep runat="server" title="Step 1">
                    學員請註冊<br />學號：<asp:TextBox ID="TextBox1" runat="server" Width="83px"></asp:TextBox>
                    <br />
                ...
                <asp:WizardStep runat="server" Title="Step 3">
                    學員密碼：<asp:TextBox ID="TextBox4" runat="server" Width="69px" TextMode="Password"></asp:TextBox>
                    <br />
                    再輸一次：<asp:TextBox ID="TextBox5" runat="server" Width="69px" TextMode="Password"></asp:TextBox>
                </asp:WizardStep>
                <asp:WizardStep runat="server" StepType="Finish" Title="Finish">
                    您已經填寫完成學員註冊之步驟，請按「完成」，可以真正成為e-Learning會員！
                </asp:WizardStep>
                <asp:WizardStep runat="server" StepType="Complete" Title="Complete">
                    恭喜您！註冊成功！<br />您的註冊相關資料如下：<br /> 
                    <br />
