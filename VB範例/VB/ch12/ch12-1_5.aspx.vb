...
Partial Class ch12_1_5
    ...
    Sub BuildChild(ByVal RootUid As Integer, ByRef Nodes As Web.UI.WebControls.TreeNodeCollection)
        ...
        Next
    End Sub
    Protected Sub TreeView1_SelectedNodeChanged1(sender As Object, e As System.EventArgs) Handles TreeView1.SelectedNodeChanged
        Label1.Text = "你剛才選了：" & TreeView1.SelectedNode.Text
    End Sub
End Class
